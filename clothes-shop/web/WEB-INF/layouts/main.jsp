...
<!--                <a style="font-size: 20px" href="<c:url value="/login/logout.do"/>" class="btn btn-outline-dark"><i class="bi bi-person-plus-fill"></i> Register</a>-->
                </c:otherwise>
            </c:choose>
        ...
        <div class="row footer" style="background-color: black; color: white">
            <div class="col">
                <br/>
                &copy; Copyright by team 5 class SE1507. Do not reup.
                <br/>
                <br/>
            </div>
        </div>
